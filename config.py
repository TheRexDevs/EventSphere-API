...
class Config:
    ...
    CLIENT_ORIGINS = os.getenv("CLIENT_ORIGINS") or os.environ.get("CLIENT_ORIGINS") or "http://localhost:3000,http://localhost:3002,http://localhost:5173,http://localhost:5000"
